...
import java.io.*;
import java.net.*;
import com.grand.util.SMSConfig;
...
public class SMSComponent {
	...
	// 실제 발송하는 과정입니다.
	public String SendMsg(String strDestList, String strCallBack, String strSubject, String strData, int nCount) throws Exception
	{
